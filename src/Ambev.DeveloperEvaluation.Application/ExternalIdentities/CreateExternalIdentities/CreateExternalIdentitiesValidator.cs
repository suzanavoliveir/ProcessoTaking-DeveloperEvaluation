...
/// </summary>
public class CreateExternalIdentitiesCommandValidator : AbstractValidator<CreateExternalIdentitiesCommand>
{
    /// <summary>
    ...
    /// </remarks>
    public CreateExternalIdentitiesCommandValidator()
    {
